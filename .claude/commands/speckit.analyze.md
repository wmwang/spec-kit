---
description: Perform a non-destructive cross-artifact consistency and quality analysis across spec.md, plan.md, and tasks.md after task generation. Pure skill version - no CLI installation required.
---
...
- **Requirements inventory**: Each functional + non-functional requirement with a stable key
  - Derive slug from imperative phrase (e.g., "User can upload file" → `user-can-upload-file`)
- **User story/action inventory**: Discrete user actions with acceptance criteria
- **Task coverage mapping**: Map each task to one or more requirements or stories
  - Infer by keyword matching / explicit ID references
...
*(Add one row per finding; generate stable IDs prefixed by category initial: A=Ambiguity, C=Conflict, D=Duplication, G=Gap, I=Inconsistency, U=Underspec)*
...
- Provide explicit command suggestions:
  - e.g., "Run `/speckit.specify` with refinement"
  - e.g., "Run `/speckit.plan` to adjust architecture"
  - e.g., "Manually edit tasks.md to add coverage for 'performance-metrics'"
